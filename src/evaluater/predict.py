...
def main(base_model_name, weights_file, n_classes, image_source, predictions_dir, img_format='jpg'):
    # load samples
    ...
    if predictions_dir is not None:
        save_json(samples, join(predictions_dir, "predictions.json"))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-pf', '--predictions-dir', help='directory for predictions', required=False, default=None)
